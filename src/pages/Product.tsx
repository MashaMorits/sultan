            ...
            <div className="product">
                ...
                <div className="product__info">
                    ...
                    <div className="row row-price">
                        ...
                        <div className="button" onClick={(event: React.MouseEvent<HTMLElement>) => addToCart(event)}>
                            <p>В корзину</p>
                    ...
                    <div className="description">
                        <div className="subtitle" data-testid='toggleBtn' onClick={() => setShowDescription(prev=> !prev)}>
                            <p>Описание</p>
                            <img src={show} alt="" />
                        </div>
                        {showDescription && <p data-testid='toggleDescription'>{product?.description}</p>}
                    </div>
